  ...
  <main className="min-h-screen bg-[#faf9f7] dark:bg-[#0c0b0a] py-16 px-5 sm:px-8" id="main-content">
    <div className="max-w-2xl mx-auto space-y-10">
      ...
      <div className="space-y-3">
        ...
        <h1
          className="text-3xl font-bold font-playfair text-slate-900 dark:text-slate-50"
        >
          Cookie Policy
        </h1>
      ...
      <div className="space-y-8">
        <Section title="1. What Are Cookies?">
          <p>
            ...
            application. They help us recognise you, remember your preferences, and improve your experience.
          </p>
        </Section>
        ...
        <Section title="2. How We Use Cookies">
          ...
          <ul className="list-disc list-inside space-y-1 pl-1">
            <li><strong className="text-slate-700 dark:text-slate-300">Essential cookies</strong> — Required for core functionality such as authentication and session management. These cannot be disabled.</li>
            <li><strong className="text-slate-700 dark:text-slate-300">Analytics cookies</strong> — Help us understand how users interact with SpeakDiary so we can improve it. All data is anonymised.</li>
            <li><strong className="text-slate-700 dark:text-slate-300">Preference cookies</strong> — Remember your settings such as dark mode and language.</li>
          </ul>
          <p>We do <strong className="text-slate-700 dark:text-slate-300">not</strong> use advertising or tracking cookies.</p>
        </Section>
        ...
        <Section title="3. Cookies We Set">
          <CookieTable rows={[
            ...
            { name: "__dodo_mid",   provider: "DodoPayments",   purpose: "Fraud prevention during checkout",    duration: "1 year" },
            { name: "_ga",          provider: "Google",         purpose: "Anonymous usage analytics",           duration: "2 years" },
            { name: "_ga_*",        provider: "Google",         purpose: "Analytics session identifier",        duration: "2 years" },
          ]} />
        </Section>

        <Section title="4. Third-Party Cookies">
          <p>
            Some cookies are set by third-party services we use, including Dodo (payments) and
            Google Analytics (anonymised usage stats). These services have their own cookie policies.
          </p>
        </Section>

        <Section title="5. Managing Your Cookies">
          <p>
            You can control and/or delete cookies through your browser settings. Disabling essential
            cookies will prevent you from logging in and using core features.
          </p>
          <p>
            To opt out of Google Analytics across all websites, you may install the{" "}
            <a
        ...
        <Section title="6. Cookie Consent">
          <p>
            On your first visit, we display a cookie notice. By continuing to use SpeakDiary, you
            consent to our use of cookies as described in this policy. You may withdraw consent at
            any time by clearing your browser cookies and not continuing to use the service.
          </p>
        </Section>

        <Section title="7. Updates to This Policy">
          <p>
            We may update this Cookie Policy from time to time. Any changes will be communicated via
            the in-app notice and by updating the date above.
          </p>
        </Section>
